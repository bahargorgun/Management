...
public class CTMKPSPublicSoap
{
    ...
    public CTMKPSPublicSoap(){}

    public CTMKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CTMKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CTMExtendedSoapSerializationEnvelope envelope= new CTMExtendedSoapSerializationEnvelope(CTMExtendedSoapSerializationEnvelope.VER11);
