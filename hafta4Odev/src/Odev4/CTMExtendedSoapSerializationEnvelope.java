...
public class CTMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CTMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CTMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CTMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CTMDateTimeConverter dateTimeConverter = new CTMStandardDateTimeConverter();

    public CTMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CTMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CTMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CTMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CTMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CTMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
